        ...
        for si, s in enumerate(strands):
            ...
            for i in cidx:
                ...
                if CFG['verbose'] and (c+1) % 100 == 0:
                    print('\r %i(%i) genes done (found %i new retentions in %i tested introns, %2.1f%%)' % (c+1, genes.shape[0], num_introns_added, num_introns, 100 * num_introns_added / float(max(1, num_introns))), file=sys.stdout)
